...
func TestResistanceFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 Ω"},
		{1.23456789, "%.1v", "1 Ω"},
		{1.23456789, "%20.1v", "                 1 Ω"},
		{1.23456789, "%20v", "        1.23456789 Ω"},
		{1.23456789, "%1v", "1.23456789 Ω"},
		{1.23456789, "%#v", "unit.Resistance(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Resistance=1.23456789 Ω)"},
	} {
