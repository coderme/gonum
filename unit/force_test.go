...
func TestForceFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 N"},
		{1.23456789, "%.1v", "1 N"},
		{1.23456789, "%20.1v", "                 1 N"},
		{1.23456789, "%20v", "        1.23456789 N"},
		{1.23456789, "%1v", "1.23456789 N"},
		{1.23456789, "%#v", "unit.Force(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Force=1.23456789 N)"},
	} {
