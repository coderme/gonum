...
func TestTemperatureFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 K"},
		{1.23456789, "%.1v", "1 K"},
		{1.23456789, "%20.1v", "                 1 K"},
		{1.23456789, "%20v", "        1.23456789 K"},
		{1.23456789, "%1v", "1.23456789 K"},
		{1.23456789, "%#v", "unit.Temperature(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Temperature=1.23456789 K)"},
	} {
