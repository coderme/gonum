...
func TestRadioactivityFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 Bq"},
		{1.23456789, "%.1v", "1 Bq"},
		{1.23456789, "%20.1v", "                1 Bq"},
		{1.23456789, "%20v", "       1.23456789 Bq"},
		{1.23456789, "%1v", "1.23456789 Bq"},
		{1.23456789, "%#v", "unit.Radioactivity(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Radioactivity=1.23456789 Bq)"},
	} {
