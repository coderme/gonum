...
func TestAreaFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 m^2"},
		{1.23456789, "%.1v", "1 m^2"},
		{1.23456789, "%20.1v", "               1 m^2"},
		{1.23456789, "%20v", "      1.23456789 m^2"},
		{1.23456789, "%1v", "1.23456789 m^2"},
		{1.23456789, "%#v", "unit.Area(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Area=1.23456789 m^2)"},
	} {
