...
func TestVoltageFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 V"},
		{1.23456789, "%.1v", "1 V"},
		{1.23456789, "%20.1v", "                 1 V"},
		{1.23456789, "%20v", "        1.23456789 V"},
		{1.23456789, "%1v", "1.23456789 V"},
		{1.23456789, "%#v", "unit.Voltage(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Voltage=1.23456789 V)"},
	} {
