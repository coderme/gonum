...
func TestConductanceFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 S"},
		{1.23456789, "%.1v", "1 S"},
		{1.23456789, "%20.1v", "                 1 S"},
		{1.23456789, "%20v", "        1.23456789 S"},
		{1.23456789, "%1v", "1.23456789 S"},
		{1.23456789, "%#v", "unit.Conductance(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Conductance=1.23456789 S)"},
	} {
