...
func TestEnergyFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 J"},
		{1.23456789, "%.1v", "1 J"},
		{1.23456789, "%20.1v", "                 1 J"},
		{1.23456789, "%20v", "        1.23456789 J"},
		{1.23456789, "%1v", "1.23456789 J"},
		{1.23456789, "%#v", "unit.Energy(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Energy=1.23456789 J)"},
	} {
