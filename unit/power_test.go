...
func TestPowerFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 W"},
		{1.23456789, "%.1v", "1 W"},
		{1.23456789, "%20.1v", "                 1 W"},
		{1.23456789, "%20v", "        1.23456789 W"},
		{1.23456789, "%1v", "1.23456789 W"},
		{1.23456789, "%#v", "unit.Power(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Power=1.23456789 W)"},
	} {
