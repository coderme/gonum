...
func TestMassFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{1.23456789, "%v", "1.23456789 kg"},
		{1.23456789, "%.1v", "1 kg"},
		{1.23456789, "%20.1v", "                1 kg"},
		{1.23456789, "%20v", "       1.23456789 kg"},
		{1.23456789, "%1v", "1.23456789 kg"},
		{1.23456789, "%#v", "unit.Mass(1.23456789)"},
		{1.23456789, "%s", "%!s(unit.Mass=1.23456789 kg)"},
	} {
