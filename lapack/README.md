Gonum LAPACK [![GoDoc](https://godoc.org/github.com/coderme/gonum/lapack?status.svg)](https://godoc.org/github.com/coderme/gonum/lapack)
======
...
```
  go get github.com/coderme/gonum/lapack/...
```
